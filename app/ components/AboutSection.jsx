...
const TAB_DATA = [
    {
        ...
        content: (
            <ul className="list-disc pl-2">
                ...
                <li><span className="text-[#F5E8DD] font-bold  ">Debate Championships</span>:  14th Visayas Universities Debating Championship, Visayas Intervarsity 2021, Dominis Canis Cup 2021, and 7th Visayas Universities Debating Championship - British Parliament</li>
            </ul>
        )
    }, 
    {
        ...
        content: (
            <ul className="list-disc pl-2">
                <li><span className="text-[#F5E8DD] font-bold  ">Finance Committee</span> of UP SayawE [September 2022 - Present]</li>
                <li><span className="text-[#F5E8DD] font-bold  ">Tournament director</span> of Visayas Intervarsity 2022</li>
                <li><span className="text-[#F5E8DD] font-bold  ">President</span> of Cebu Interschool Debating Association [2021 - 2022]</li>
                <li><span className="text-[#F5E8DD] font-bold  ">Prime Minister</span> of Josenian Debate Varsity [Academic Year 2021-2022]</li>
            </ul>
        )
    }, 
    {
        ...
        content: (
            <ul className="list-disc pl-2">
                <li><span className="text-[#F5E8DD] font-bold  ">University of the Philippines Cebu</span> </li>
                <ul className="pl-2 ml-5">
                    <li>2nd Year BS Computer Science</li>
                </ul>
                <li><span className="text-[#F5E8DD] font-bold  ">University of San Jose - Recoletos</span> </li>
                <ul  className="pl-2 ml-5">
...
const AboutSection = () => {
  ...
  return (
    <section className="text-white" id="about">
        {/* <div className="md:grid md:grid-cols-2 md:gap-x-4 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16"> */}
        ...
        <div className = "md:order-1 flex justify-end">
            ...
            <div className = "md:order-2 mt-4 md:mt-0 text-left flex flex-col flex-grow">
                ...
                <div className="
                flex flex-row  justify-center mt-8 space-x-5">
                        <TabButton
                    ...
                    <div className="mt-8 mx-8 sm:mx-12 md:mx-16 lg:mx-20 xl:mx-24">
